...
def make_HM_detection_env_0(clock,
                            dome_specs,
                            moon,
                            energy,
                            eclss,
                            ...
                            interior_env,
                            agents):
    with System(name="HM_detection", description="The HM_detection environment") as HM_detection:
        fault_limit = Parameter(name="fault_limit",
                                value= {'error_1': {'name_state' : "structure_secs",
                                                    'name_system' : struct,
                                        ...
                                        'error_2': {'name_state': "accum_dust_solar",
                                                    'name_system': energy,
                                                    ...
                                                    'time_to_failure' : 100,
                                                    'cyber_physical' : 'Physical'},
                                        'error_3': {'name_state': "accum_dust_nuclear",
                                                    'name_system': energy,
                                                    'min_acceptable_value': 0.90,
                                                    'max_acceptable_value': math.inf,
                                                    'current_value' : 1.00,
                                                    'time_to_failure' : 100,
                                                    'cyber_physical' : 'Physical'},
                                        'error_4': {'name_state': "int_env_temp",
                                        ...
                                        'error_4': {'name_state': "int_env_pres",
                                                    'name_system': interior_env,
        ...
        def f_detection(clock=clock,
            ...
            for key in fault_limit.keys():
                ...
                fault_limit[key]['name_system'].current_value = fault_limit[key]['name_system'].state_name.value
                if fault_limit[key]['min_acceptable_value'] > fault_limit[key]['name_system'].current_value:
                    fault_list_new.append(fault_limit[key]['name_system'].state_name)
                elif fault_limit[key]['max_acceptable_value'] < fault_limit[key]['name_system'].current_value:
