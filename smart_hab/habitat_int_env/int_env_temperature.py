...
def make_int_env_temperature_env_0(en_used_heat,
    ...
    with System(name="int_env_temperature",
                description="The int_env_temperature environment") as int_env_temperature:
        int_env_temp = (
            make_node(
                "S:int_env_temp",
                value=298.0,
        ...
        def f_interior_env_heat(lower_temp_setpo=HM_temperature_lower_setpoint,
