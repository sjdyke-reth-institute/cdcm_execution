...
def make_int_env(dome_specs,
    ...
    with System(name="int_env", description="The int_env system") as int_env:
        ...
        int_env_pressure = make_int_env_pressure_env(dome_specs, eclss_en_used_pres, eclss_en_needed_pres, struct_health, HM_pressure_lower_setpoint, HM_pressure_upper_setpoint)

        int_env_temperature = make_int_env_temperature_env(eclss_en_used_heat, eclss_en_needed_heat, struct_inside_temperature, HM_temperature_lower_setpoint, HM_temperature_upper_setpoint)
