...
def make_health_managment_physical_env_0(clock,
                                         dome_specs,
                                         moon,
                                         energy,
                                         eclss,
    ...
    with System(name="health_managment_physical", description="The health_managment_physical environment") as health_managment_physical:
