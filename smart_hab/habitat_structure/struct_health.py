...
def make_struct_health_env_0(meteor_impacts_1,
                             meteor_impacts_2,
                             meteor_impacts_3,
                             meteor_impacts_4,
                             meteor_impacts_5,
                             agent_repair_struct):
    with System(name="struct_health",
                description="The struct_health environment") as struct_health:
