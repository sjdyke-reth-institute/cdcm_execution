...
def make_energy_generate_energy_env_0(clock, moon, energy_performance):
    with System(
        name="energy_generate_energy",
        description="The energy_generate_energy environment",
    ) as energy_generate_energy:
