...
for sample_building in single_zone_building.sample(1):
    ...
    print('\n R_oe',rc_sample[0].R_oe,
            '\n C_env',rc_sample[0].C_env,
            '\n R_er',rc_sample[0].R_er,
            '\n R_gr',rc_sample[0].R_gr,
            '\n R_ge',rc_sample[0].R_ge,
            '\n C_genv', rc_sample[0].C_genv,
            '\n R_rc',rc_sample[0].R_rc)
    sys = System(
            name="everything",
