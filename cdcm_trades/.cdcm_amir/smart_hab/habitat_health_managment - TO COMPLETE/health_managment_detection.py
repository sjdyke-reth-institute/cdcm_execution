...
def make_health_managment_detection_env_0(
    clock, dome_specs, moon, energy, eclss, struct, interior_env, agents
):
    with System(
        name="health_managment_detection",
        description="The health_managment_detection environment",
    ) as health_managment_detection:
