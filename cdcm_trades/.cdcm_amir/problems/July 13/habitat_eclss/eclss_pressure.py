...
def make_eclss_pressure_env_0(
    ...
    with System(
        name="eclss_pressure", description="The eclss_pressure environment"
    ) as eclss_pressure:
        ...
        # print(struct_health)
        @make_function(en_needed_pres, en_used_pres)
        def f_eclss_pres(
            lower_pressure_setpo=HM_pressure_lower_setpoint,
            upper_pressure_setpo=HM_pressure_upper_setpoint,
            # struct_health=struct_health,  #  Check here; comment only this line or line 71
            ...
            struct_health=struct_health,  #  Check here; comment only this line or line 65
            ...
            en_needed_pres_new = max(
                0.0,
                ((lower_pressure_setpo + upper_pressure_setpo) / 2 - int_env_pres)
                * pres_capac_per_vol
                + int_env_pres
                * air_leak_coeficent
            ...
            en_used_pres_new = max(0.0, min(available_en, en_needed_pres))
            return en_needed_pres_new, en_used_pres_new
