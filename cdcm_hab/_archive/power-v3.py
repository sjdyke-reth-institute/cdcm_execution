...
# Code Begins
with System(
    name="everything", description="A system that contains everything."
) as everything:
    ...
    # Moon Enviornment
    with System(name="moon", description="Houses most lunar characteristics.") as moon:
        ...
        def calculated_solar_irradiance(
            t=clock.t, Imax=solar_irradiance_constant, T=lunar_day
        ):
            half_T = T / 2
    ...
    # Habitat Initiation
    with System(name="habitat", description="Houses the habitat.") as habitat:

        # Defining Power Systems
        with System(
            name="power", description="Houses habitat's power systems"
        ) as power:
            ...
            with System(
                ...
                description="Different power generation options",
            ) as power_generation:
                ...
                with System(
                    name="solar", description="Solar power generation options"
                ) as solar:

                    with System(
                        name="solar_array", description="Solar arrays assembly"
                    ) as solar_array:
                        ...
                        with System(
                            name="solar_array_1", description="solar arrays assembly #1"
                        ) as solar_array_1:
                ...
                with System(
                    name="nuclear", description="Nuclear power generation options"
                ) as nuclear:
                    pass

                # Chemical Power Generation Options.
                with System(
                    name="chemical", description="Chemical power generation options"
                ) as chemical:
                    pass
            ...
            with System(
                ...
                description="Different power distribution configurations",
            ) as power_distribution:
                pass

                # Wiring takes care of wired/wireless infrastructure.
                with System(
                    name="wiring",
                    description="This system contains wiring configurations",
                ) as wiring:
                    pass

                with System(
                    name="sequential_shunt_unit",
                    description="Regulates output to 160VdC",
                ) as ssu:
                    ...
                    with System(name="ssu1", description="ssu #1") as ssu1:
                ...
                with System(
                    ...
                    description="Connection between the power source and battery system as well as distributing power to different loads",
                ) as dcsu:
                ...
                with System(
                    name="battery_charge_discharge_unit",
                    description="Regulates charge rate and mainains bus voltage of 151VdC during an eclipse by discharging the batteries",
                ) as bcdu:
                ...
                with System(
                    name="dc_2_dc_converter",
                    description="Converts the primary input voltage to a regulated 124VdC as specified for user loads",
                ) as ddcu:
                    ...
                    with System(name="ddcu1", description="ddcu #1") as ssu1:
                ...
                with System(
                    name="remote_power_controller_module",
                    description="Contains individual switches called RPCs which are remotely commandable to apply or remove power to downstream user loads",
                ) as rpcm:
                ...
                with System(
                    name="electronics_control_unit",
                    description="Controller for beta gimbal (for solar arrays)",
                ) as ecu:
                ...
                with System(
                    name="pump_flow_controller_subassembly",
                    description="Pump system that provides cooling to the dcsu, bcdu's and batteries",
                ) as pfcs:
                ...
                with System(
                    name="main_bus_switching_unit",
                    description="Provides connectivity between a power channel and multiple downstream paths. It also allows for cross-connecting power channels in an event of a failure",
                ) as mbsu:
            ...
            with System(
                name="power_storage", description="Different power storage options"
            ) as power_storage:
                pass
