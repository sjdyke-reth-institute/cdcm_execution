...
def make_struct_health_env_0(moon,
                             agent_repair_struct):
    with System(name="struct_health", description="The struct_health environment") as struct_health:
        ...
        # def f_struct_health(structure_secs=structure_sec_1,
        ...
        #                     ):
        def f_struct_health(structure_secs=structure_secs,
                            agent_repair_struct=agent_repair_struct,
                            meteor_impacts_1=moon.meteor.meteor_impacts_1,
                            meteor_impacts_2=moon.meteor.meteor_impacts_2,
                            meteor_impacts_3=moon.meteor.meteor_impacts_3,
            ...
            print('structure_secs', structure_secs)
            input('sdadsadsadsadsadasd')
            ...
            structure_secs_new = structure_secs
