...
with System(name="combined_system") as sys:
    ...
    with System(name="sys1") as sys1:
        ...
        r1 = Parameter(name="r1", value=0.1324324324, units="meters", description="State of sys1.")
        c1 = Parameter(name="c1", value=0.87867, units="meters", description="State of sys1.")
        ...
        def f1(x1=x1, x2=placeholder, r1=r1, c1=c1):
            ...
            print('f1', 'x1', x1, 'x2', x2, 'r1', r1, 'c1', c1, )
