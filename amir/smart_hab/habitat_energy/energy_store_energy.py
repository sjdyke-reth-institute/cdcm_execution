...
def make_energy_store_energy_env_0(energy_generate, ecless_energy_cons):
    with System(
        name="energy_store_energy", description="The energy_store_energy environment"
    ) as energy_store_energy:
