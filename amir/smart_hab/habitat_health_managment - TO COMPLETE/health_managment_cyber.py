...
def make_health_managment_cyber_env_0(
    clock,
    dome_specs,
    moon,
    energy,
    ...
    with System(
        name="health_managment_cyber",
        description="The health_managment_cyber environment",
    ) as health_managment_cyber:
        health_managment_temperature_lower_setpoint = State(
            name="health_managment_temperature_lower_setpoint",
            value=280.0,
            units="K",
            description="The lower temperature set point from health_managment to ECLSS",
        )
        health_managment_temperature_upper_setpoint = State(
            name="health_managment_temperature_upper_setpoint",
            value=310.0,
            units="K",
            description="The upper temperature set point from health_managment to ECLSS",
        )
        health_managment_pressure_lower_setpoint = State(
            name="health_managment_pressure_lower_setpoint",
            value=0.80,
            units="atm",
            description="The lower pressure set point from health_managment to ECLSS",
        )
        health_managment_pressure_upper_setpoint = State(
            name="health_managment_pressure_upper_setpoint",
            value=1.05,
            units="atm",
            description="The upper pressure set point from health_managment to ECLSS",
        )
        health_managment_functional_covered = State(
        ...
        @make_function(
            health_managment_temperature_lower_setpoint,
