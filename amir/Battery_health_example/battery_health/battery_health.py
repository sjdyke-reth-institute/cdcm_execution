...
def make_battery_health(clock,
    ...
    """
    with System(name="battery_health", description="The battery_health system") as battery_health:


        make_battery_health_degaradation = make_battery_health_degaradation_env(clock,
                                                                                battery_specs)

        make_battery_health_shock = make_battery_health_shock_env(battery_specs,
                                                                  high_current,
                                                                  make_battery_health_degaradation.battery_degeradation_state)

        make_battery_health_overal = make_battery_health_overal_env(make_battery_health_degaradation,
                                                                    make_battery_health_shock)
