...
def make_struct_temp_env_0(struct_health,
                           dome_specs,
                           moon,
                           int_env_temp):
    with System(name="struct_temp", description="The struct_temp environment") as struct_temp:
        
        ext_str_temp = State(name="ext_str_temp",
                                  value=100.0,
                                  units="",
                                  description="Temperature of the outer side of the dome wall")
        int_str_temp = State(name="int_str_temp",
                                  value=320.0,
                                  units="",
                                  description="Temperature of the inner side of the dome wall")
        @make_function(ext_str_temp,
                       int_str_temp)
