...
def make_eclss_energy_consumption_env_0(
    available_en, eclss_pressure, eclss_temperature
):
    with System(
        name="eclss_energy_consumption",
        description="The eclss_energy_consumption environment",
    ) as eclss_energy_consumption:
        energy_cons = make_node(
            "S:energy_cons",
            value=0.0,
            units="J",
