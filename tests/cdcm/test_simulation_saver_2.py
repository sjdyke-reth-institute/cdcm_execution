...
r1 = make_node("P:r1:-0.0001:meters/second", description="Rate parameter for sys1.")
...
y1 = Variable(
    ...
    value=0.5,
    units="meters",
    description="Sensor measurement sys1."
)
...
r2 = make_node("P:r2:-0.001:meters/second",)
c2 = make_node("P:c2:.1:1/second")
s2 = make_node(
    "P:s2:0.01:meters",
    description="Standard deviation of measurement noise"
)
y2 = Variable(
    ...
    value=0.5,
    units="meters",
    description="Sensor measurement sys2."
)
...
max_steps = 10000
saver = SimulationSaver("test_2.h5", sys, max_steps=max_steps)
